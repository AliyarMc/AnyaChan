  ...
  return (
    <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-20">
      <div className="lg:col-span-2 space-y-6">
        <div className="bg-[#393a41] rounded-2xl overflow-hidden shadow-xl shadow-black/20 border border-white/10">
        ...
        <div className="bg-[#393a41] rounded-2xl p-8 relative overflow-hidden group border border-white/10">
      ...
      <div className="space-y-6">
        <div className="bg-[#393a41] rounded-2xl p-6 relative overflow-hidden group shadow-lg border border-white/10">
