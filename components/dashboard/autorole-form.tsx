  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
      <div className="lg:col-span-3 space-y-6">
        <div className="bg-[#393a41] rounded-2xl shadow-2xl p-8 space-y-10 relative border border-white/10">
      ...
      <div className="space-y-6">
        <div className="bg-gradient-to-br from-[#393a41] to-slate-900 rounded-2xl p-6 relative overflow-hidden group border border-white/10">
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <p className="text-[11px] text-slate-400 leading-relaxed">
                <span className="text-slate-200 font-bold">Hierarchy Matter:</span> Ensure Anya&apos;s top role is <span className="text-primary italic">higher</span> than any role you select here.
              </p>
            </div>
            <div className="flex gap-3">
              <div className="h-1.5 w-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
