    ...
    <div className="min-h-screen bg-[#0c0f16] text-slate-200 font-sans">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/[0.03] bg-[#0c0f16]/80 backdrop-blur-3xl px-6 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-4 group">
          ...
          <span className="text-xl font-bold text-white font-outfit uppercase tracking-tighter">Anya Engine</span>
        </Link>
        <Link href="/">
      ...
      <main className="relative z-10 pt-40 pb-32 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass border-white/5 rounded-2xl p-10 md:p-16 space-y-12">
            <section className="space-y-6">
              ...
              <p className="text-slate-400 leading-relaxed font-medium">
                The Anya Engine collects only the minimum necessary data to function within Discord. This includes your Discord User ID, Server (Guild) ID, and configuration settings provided during setup. We do not store message content unless explicitly configured for logging purposes by server administrators.
              </p>
            </section>
