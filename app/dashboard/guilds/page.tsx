    ...
    <div className="space-y-8">
      ...
      {error ? (
        ...
        <div className="bg-slate-800/30  border-dashed p-16 rounded-3xl text-center">
          ...
          <div className="mt-8 bg-white/[0.03]/50 p-4 rounded-xl text-left font-mono text-sm text-slate-300 max-w-2xl mx-auto overflow-auto max-h-48 whitespace-pre">
          ...
          {guilds.map((guild) => (
            ...
            >
                  ...
                  <div className="relative">
                    {guild.icon_url ? (
                      <Image 
                        ...
                        width={64}
                        height={64}
                        className="rounded-2xl shadow-xl group-hover:scale-105 transition-transform"
                      />
                    ) : (
                      <div className="h-16 w-16 bg-white/10 rounded-2xl flex items-center justify-center text-white font-bold text-2xl shadow-xl group-hover:scale-105 transition-transform">
                        {guild.name.charAt(0)}
                      </div>
                    )}
              ...
              <div className="px-6 py-4 bg-white/[0.02]">
                <Button className="w-full justify-between group/btn py-6 bg-white/10 hover:bg-white/15 text-white font-bold rounded-2xl" variant="secondary" asChild>
