    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3 space-y-4">
           {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-32 w-full bg-white/[0.04] rounded-2xl animate-pulse" />
           ))}
        </div>
        <div className="space-y-6">
           <div className="h-64 w-full bg-white/[0.04] rounded-2xl animate-pulse" />
           <div className="h-48 w-full bg-white/[0.04] rounded-2xl animate-pulse" />
        </div>
      </div>
    </div>
  );
