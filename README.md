...
<h3>Anya Dashboard — Next.js Web Interface</h3>
...
<p>
  <a href="https://discord.gg/zaptro"><img src="https://img.shields.io/badge/Discord-Join_Server-5865F2?style=for-the-badge&logo=discord&logoColor=white"/></a>
  <a href="https://youtube.com/@ZAPTRO"><img src="https://img.shields.io/badge/YouTube-ZAPTRO-FF0000?style=for-the-badge&logo=youtube&logoColor=white"/></a>
  <a href="https://github.com/ZAPTRO"><img src="https://img.shields.io/badge/GitHub-ZAPTRO-181717?style=for-the-badge&logo=github&logoColor=white"/></a>
</p>
...
This folder contains the Anya web dashboard built with `Next.js 14` (App Router), `TypeScript`, and `Tailwind CSS`. It connects to the bot's FastAPI backend via a permanent Cloudflare Tunnel HTTPS URL and lets server admins manage all bot settings through a sleek, branded UI.
...
|---|---|
| Node.js 18+ | — |
| Anya bot running | with `API_ENABLED=true` and `TUNNEL_ENABLED=true` |
...
<a href="https://discord.gg/zaptro"><img src="https://discord.com/api/guilds/1301573144817045524/widget.png?style=banner2" alt="Zaptro Discord Server" width="480"/></a>
